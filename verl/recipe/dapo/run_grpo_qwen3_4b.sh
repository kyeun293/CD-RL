...
project_name='CDRL-GRPO-Qwen3-4B-Base'
exp_name='GRPO-stepCuriosity-dynamicEta-Qwen3-4B-Base-1.7k-expBeta-beta1.0'
...
dynamic_eta_beta=1.0  #SW: saturating exponential reshape of the raw std eta; 0/null disables it
